...
class StageLossManager(nn.Module):
    def __init__(self, args):
        super(StageLossManager, self).__init__()
        self.args = args
        ...
        self.relation_embedding = nn.Parameter(torch.empty(self.args.nrelation, 256), requires_grad=True)
